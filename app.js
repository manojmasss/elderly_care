...
recognition.onresult = function (event) {
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    if(transcript.includes("telemedicine.")||transcript.includes("online medicine")){
      readOut("opening online doctor considation");
      let a= window.open("https://www.sriramakrishnahospital.com/minor-department/general-medicine/");
      windowsB.push(a)
    }
    if(transcript.includes("who i am")||transcript.includes("i'm")){
      readOut("You Are Mass The Black Hat Hacker");
    }
    // jarvis commands
  ...
  // spotify
    ...
    if (transcript.includes("set medicine") || transcript.includes("medicine time")) {
      readOut("opening.......");
      window.open("http://127.0.0.1:5500/Jarvis-With-JavaScript-master/alaram.html");
    }
